// app/gallery/[id]/gallery-image-client.tsx
'use client'
...
export default function GalleryImageClient({ imageId, initialImage }: GalleryImageClientProps) {
  const { toast } = useToast()
  const supabase = useSupabase()

  const [image] = useState<GalleryImage>(initialImage)
  ...
  return (
    <>
      ...
      <div className="flex justify-end mb-8">
        <Link
          href="/archivegallery"
          className="inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium transition-colors hover:bg-muted hover:text-foreground"
